...
const socialLinks = [
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/bia-bez/",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    <section id="contact" className={`section ${styles.section}`}>
      ...
      <div className={`container ${styles.container}`}>
        ...
        <div className={styles.ctaCard}>
          ...
          {/* Email CTA */}
          <a
            href="https://mail.google.com/mail/?view=cm&to=bia.bezerra.dev@gmail.com&su=Contato%20pelo%20portfólio"
            target="_blank"
            rel="noopener noreferrer"
            className={`btn btnPrimaryHero ${styles.emailBtn}`}
          >
            Enviar e-mail
            <svg
              width="16"
